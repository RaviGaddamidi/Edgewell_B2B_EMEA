 ...
 *  
 */
package com.energizer.energizeraccountsummary.hmc;
...
/**
 * Provides necessary meta information about the accountsummary hmc extension.
 * 
 * 
 * @version ExtGen v5.0.2.0
 */
public class AccountsummaryaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AccountsummaryaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.energizer.energizeraccountsummary.hmc.locales";
