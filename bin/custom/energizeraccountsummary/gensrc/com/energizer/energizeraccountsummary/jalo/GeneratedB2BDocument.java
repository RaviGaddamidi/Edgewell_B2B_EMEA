...
import com.energizer.energizeraccountsummary.jalo.B2BDocumentPaymentInfo;
import com.energizer.energizeraccountsummary.jalo.B2BDocumentType;
import com.energizer.energizeraccountsummary.jalo.DocumentMedia;
...
public abstract class GeneratedB2BDocument extends GenericItem
{
	...
	/** Qualifier of the <code>B2BDocument.documentPaymentInfo</code> attribute **/
	public static final String DOCUMENTPAYMENTINFO = "documentPaymentInfo";
	/**
	...
	**/
	...
	/**
	* {@link OneToManyHandler} for handling 1:n DOCUMENTPAYMENTINFO's relation attributes from 'many' side.
	**/
	protected static final OneToManyHandler<B2BDocumentPaymentInfo> DOCUMENTPAYMENTINFOHANDLER = new OneToManyHandler<B2BDocumentPaymentInfo>(
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>B2BDocument.documentPaymentInfo</code> attribute.
	 * @return the documentPaymentInfo
	 */
	public Collection<B2BDocumentPaymentInfo> getDocumentPaymentInfo(final SessionContext ctx)
	{
		return DOCUMENTPAYMENTINFOHANDLER.getValues( ctx, this );
	}
	 ...
	 * @return the documentPaymentInfo
	 */
	public Collection<B2BDocumentPaymentInfo> getDocumentPaymentInfo()
	{
		return getDocumentPaymentInfo( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>B2BDocument.documentPaymentInfo</code> attribute. 
	 * @param value the documentPaymentInfo
	 */
	public void setDocumentPaymentInfo(final SessionContext ctx, final Collection<B2BDocumentPaymentInfo> value)
	{
		DOCUMENTPAYMENTINFOHANDLER.setValues( ctx, this, value );
	}
	 ...
	 * @param value the documentPaymentInfo
	 */
	public void setDocumentPaymentInfo(final Collection<B2BDocumentPaymentInfo> value)
	{
		setDocumentPaymentInfo( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Adds <code>value</code> to documentPaymentInfo. 
	 * @param value the item to add to documentPaymentInfo
	 */
	public void addToDocumentPaymentInfo(final SessionContext ctx, final B2BDocumentPaymentInfo value)
	{
		DOCUMENTPAYMENTINFOHANDLER.addValue( ctx, this, value );
	}
	 ...
	 * @param value the item to add to documentPaymentInfo
	 */
	public void addToDocumentPaymentInfo(final B2BDocumentPaymentInfo value)
	{
		addToDocumentPaymentInfo( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Removes <code>value</code> from documentPaymentInfo. 
	 * @param value the item to remove from documentPaymentInfo
	 */
	public void removeFromDocumentPaymentInfo(final SessionContext ctx, final B2BDocumentPaymentInfo value)
	{
		DOCUMENTPAYMENTINFOHANDLER.removeValue( ctx, this, value );
	}
	 ...
	 * @param value the item to remove from documentPaymentInfo
	 */
	public void removeFromDocumentPaymentInfo(final B2BDocumentPaymentInfo value)
	{
		removeFromDocumentPaymentInfo( getSession().getSessionContext(), value );
	}
