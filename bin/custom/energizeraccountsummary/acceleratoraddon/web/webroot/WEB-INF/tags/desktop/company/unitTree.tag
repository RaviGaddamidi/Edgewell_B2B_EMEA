...
<%@ taglib prefix="company" tagdir="/WEB-INF/tags/addons/energizeraccountsummary/desktop/company" %>
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
<%@ attribute name="node" required="true"
			  type="de.hybris.platform.b2bacceleratorfacades.company.data.B2BUnitNodeData" %>

<spring:url value="/my-company/organization-management/accountstatus/details"
			var="unitDetailUrl">
