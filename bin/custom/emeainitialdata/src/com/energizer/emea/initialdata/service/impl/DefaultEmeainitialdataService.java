 ...
 */
package com.energizer.emea.initialdata.service.impl;
...
public class DefaultEmeainitialdataService implements EmeainitialdataService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultEmeainitialdataService.class);
	...
	{
		return DefaultEmeainitialdataService.class.getResourceAsStream("/emeainitialdata/sap-hybris-platform.png");
	}
