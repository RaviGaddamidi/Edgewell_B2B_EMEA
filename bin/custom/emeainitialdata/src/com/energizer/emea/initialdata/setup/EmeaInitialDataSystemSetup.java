 ...
 *
 */
package com.energizer.emea.initialdata.setup;
 ...
 */
@SystemSetup(extension = "emeainitialdata")
public class EmeaInitialDataSystemSetup extends AbstractSystemSetup
{
	private static final String BTG_EXTENSION_NAME = "btg";

	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(EmeaInitialDataSystemSetup.class);

	private static final String IMPORT_SAMPLE_DATA = "importSampleData";
	private static final String SAMPLE_DATA_IMPORT_FOLDER = "emeainitialdata";
	...
	public List<SystemSetupParameter> getInitializationOptions()
	{
		...
		params.add(createBooleanSystemSetupParameter(EmeaInitialDataSystemSetup.ACTIVATE_SOLR_CRON_JOBS, "Activate Solr Cron Jobs",
				true));
	...
	public void createEssentialData(final SystemSetupContext context)
	{
				...
				&& configurationService.getConfiguration().getBoolean("isEmeaEnabled"))
		{
			...
			importStoreInitialData(context, SAMPLE_DATA_IMPORT_FOLDER, EMEA, EMEA, Collections.singletonList(EMEA));
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		LOG.info("Running Latum Product Catalog");

		//importImpexFile(context, "/emeainitialdata/import/productCatalogs/emeaProductCatalog/catalog-sync.impex");

		//importImpexFile(context, "/emeainitialdata/import/productCatalogs/emeaProductCatalog/jobSearchRestriction.impex");
		//Emea Data
		if (getBooleanSystemSetupParameter(context, IMPORT_SAMPLE_DATA)
				&& configurationService.getConfiguration().getBoolean("isEmeaEnabled"))
		{
	...
	protected void importProductCatalog(final SystemSetupContext context, final String importDirectory, final String catalogName)
	{
		...
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/classifications-units.impex",
				false);

		// Load Categories
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/categories.impex", false);

		//Load Categories for Multidimensional Products
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/dimension-categories.impex",
				false);
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/categories-media.impex", false);
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/categories-classifications.impex",
				false);

		// Load Suppliers
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/suppliers.impex", false);

		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/suppliers-media.impex", false);
		...
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/dimension-products.impex");

		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/products-media.impex", false);

		//Load Multidimensional Products Media
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/dimension-products-media.impex",
				false);

		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/products-classifications.impex",
				false);

		// Load Products Relations
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/products-relations.impex", false);

		// Load Prices
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/products-prices.impex", false);

		//Load Product for Multidimensional Products
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/dimension-products-prices.impex",
				false);

		// Load Stock Levels
		importImpexFile(context,
				"/" + importDirectory + "/import/productCatalogs/" + catalogName + "ProductCatalog/products-stocklevels.impex",
				false);
	...
	protected void importContentCatalog(final SystemSetupContext context, final String importDirectory, final String catalogName)
	{
		...
		importImpexFile(context, importRoot + "/contentCatalogs/" + catalogName + "ContentCatalog/mycompany-cms-content.impex",
				true);
		importImpexFile(context, importRoot + "/contentCatalogs/" + catalogName + "ContentCatalog/mycompany-cms-content_en.impex",
				true);
		importImpexFile(context, importRoot + "/contentCatalogs/" + catalogName + "ContentCatalog/mycompany-cms-content_es.impex",
				true);
