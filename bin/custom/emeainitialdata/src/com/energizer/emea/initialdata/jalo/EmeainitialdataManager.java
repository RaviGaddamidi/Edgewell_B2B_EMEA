 ...
 */
package com.energizer.emea.initialdata.jalo;
...
import com.energizer.emea.initialdata.constants.EmeainitialdataConstants;



/**
 * This is the extension manager of the Emeainitialdata extension.
 */
public class EmeainitialdataManager extends GeneratedEmeainitialdataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(EmeainitialdataManager.class);
	 ...
	 */
	public static EmeainitialdataManager getInstance()
	{
		return (EmeainitialdataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(EmeainitialdataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EmeainitialdataManager() // NOPMD 
	{
		LOG.debug("constructor of EmeainitialdataManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of EmeainitialdataManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of EmeainitialdataManager called, current tenant: {}", getTenant().getTenantID());
	}
