...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/emeastorefront/electronics/en",
						"https://electronics.local:9002/emeastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/emeastorefront/electronics/en",
						"https://electronics.local:9002/emeastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/emeastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/emeastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/emeastorefront/electronics/en",
						"https://electronics.local:9002/emeastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/emeastorefront",
						"https://electronics.local:9002/emeastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/emeastorefront",
						"https://electronics.local:9002/emeastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/emeastorefront/electronics/en",
						"https://electronics.local:9002/emeastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
