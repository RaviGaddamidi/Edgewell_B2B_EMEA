 ...
 *  
 */
package com.energizer.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(EnergizerFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(EnergizerFulfilmentProcessConstants.PARENT_PROCESS);
