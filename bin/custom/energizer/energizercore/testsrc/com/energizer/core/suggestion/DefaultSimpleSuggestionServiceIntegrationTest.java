 ...
 *  
 */
package com.energizer.core.suggestion;
...
import com.energizer.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/energizercore/test/testSimpleSuggestionService.csv", "utf-8");
	}
	...
	public void testReferencesForPurchasedInCategory()
	{
		...
		result = b2bSimpleSuggestionService.getReferencesForPurchasedInCategory(category, user, Collections.EMPTY_LIST, false,
