 ...
 *  
 */
package com.energizer.core.hmc;
...
/**
 * Provides necessary meta information about the energizercore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class EnergizerCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(EnergizerCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.energizer.core.hmc.locales";
