...
public class MccSiteUrlHelper
{
	...
	{
		final MccSiteUrlHelper mccSiteUrlHelper = Registry.getApplicationContext().getBean("b2bMccSiteUrlHelper",
	...
	public Map<String, String> getSitesAndUrls()
	{
		...
		for (final CMSSiteModel cmsSiteModel : getCmsSiteService().getSites())
		{
			...
			if (url != null && !url.isEmpty() && SiteChannel.B2B.equals(cmsSiteModel.getChannel()))
			{
