...
/**
 * <p>
 * Java class for BAPIRET2_fa2309 complex type.
 * 
 * <p>
 * The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BAPIRET2_fa2309">
 *   &lt;complexContent>
...
public class BAPIRET2_Fa2309
{
	...
	{
		return "type=" + type.getValue() + ", id=" + id.getValue() + ", number=" + number.getValue() + ", <br/> message="
				+ message.getValue() + ", logNO=" + logNO.getValue() + ", logMSGNO=" + logMSGNO.getValue() + ",<br/> messageV1="
				+ messageV1.getValue() + ", messageV2=" + messageV2.getValue() + ", <br/> messageV3=" + messageV3.getValue()
				+ ", messageV4=" + messageV4.getValue() + ", parameter=" + parameter.getValue() + ", <br/> row=" + row.getValue()
				+ ", field=" + field.getValue() + ", system=" + system.getValue();
	}
