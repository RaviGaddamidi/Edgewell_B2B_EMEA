 ...
 *  
 */
package com.energizer.storefront.web.theme;
...
public class StorefrontResourceBundleSource implements ThemeSource, ResourceLoaderAware, MessageSource
{
	...
	private String addonBasenamePrefix;
	...
	public String getAddonBasenamePrefix()
	{
			...
			final String... nameParts)
	{
		...
		{
			final String basename = getAddonBasenamePrefix() + addOnName + "/" + lastBasenamePart;
