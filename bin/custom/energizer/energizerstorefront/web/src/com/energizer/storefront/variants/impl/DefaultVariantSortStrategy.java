 ...
 *  
 */
package com.energizer.storefront.variants.impl;
 ...
 * Use {@link #setSortingFieldsOrder(List)} property to set up attributes to sort by. E.g give A,B attributes and
 * sorting will be performed first against A attribute and if two values are considered equal (by A) then values of B
 * attribute are compared.<br>
 * Use {@link #setComparators(Map)} to provide comparators for particular attributes.
 */
