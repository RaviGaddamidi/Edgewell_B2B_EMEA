...
import com.energizer.storefront.breadcrumb.impl.StorefinderBreadcrumbBuilder;
...
import com.energizer.storefront.forms.StoreFinderForm;
import com.energizer.storefront.forms.StorePositionForm;
...
public class StoreLocatorPageController extends AbstractSearchPageController
{
	...
	public String findStores(@RequestParam(value = "page", defaultValue = "0") final int page, @RequestParam(value = "show",
			defaultValue = "Page") final AbstractSearchPageController.ShowMode showMode, @RequestParam(value = "sort",
			required = false) final String sortCode, @RequestParam(value = "q") final String locationQuery, @RequestParam(
			value = "latitude", required = false) final Double latitude,
	...
	public String searchByCurrentPosition(@RequestParam(value = "page", defaultValue = "0") final int page, @RequestParam(
			value = "show", defaultValue = "Page") final AbstractSearchPageController.ShowMode showMode, @RequestParam(
			value = "sort", required = false) final String sortCode, final StorePositionForm storePositionForm, final Model model)
	...
	protected void setUpMetaData(final String locationQuery, final Model model)
	{
		...
		final String metaDescription = MetaSanitizerUtil.sanitizeDescription(getSiteName()
				+ " "
				+ getMessageSource()
						.getMessage("storeFinder.meta.description.results", null, getI18nService().getCurrentLocale()) + " "
				+ locationQuery);
