...
public class AddressForm
{
	...
	@Size(min = 1, max = 25, message = "{address.firstName.invalid}")
	@Pattern(regexp = "[a-z-A-Z]*", message = "{address.firstName.invalid}")
	...
	@Size(min = 1, max = 25, message = "{address.lastName.invalid}")
	@Pattern(regexp = "[a-z-A-Z]*", message = "{address.lastName.invalid}")
	...
	@Size(min = 1, max = 50, message = "{address.line1.invalid}")
	...
	@Size(min = 1, max = 25, message = "{address.townCity.invalid}")
	@Pattern(regexp = "[a-z-A-Z]*[\\s]*", message = "{address.townCity.invalid}")
	...
	@Size(min = 5, max = 10, message = "{address.postcode.invalid}")
	@Pattern(regexp = "[0-9]{5}-[0-9]{4}", message = "{address.postcode.invalid}")
