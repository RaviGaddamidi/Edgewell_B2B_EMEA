...
public class ProductCarouselComponentController extends AbstractCMSComponentController<ProductCarouselComponentModel>
{
	...
	{
		List<ProductData> searchResults = new ArrayList<>();
		...
		if (searchQueryData.getValue() != null && categoryCode != null)
		{
			...
			final ProductCategorySearchPageData<SearchStateData, ProductData, CategoryData> pageData = productSearchFacade
					.categorySearch(categoryCode, searchState, pageableData);
			searchResults = pageData.getResults();
		}
