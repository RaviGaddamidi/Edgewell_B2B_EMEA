...
<template:page pageTitle="${pageTitle}">
	...
	<div class="column accountContentPane clearfix">
		...
		<div class="myaccount_payment_head">
			<span class="span-4">Payment Card</span>
			<span class="span-9">Billing Address</span>
			<span class="span-5 right"></span>
<!-- 			<span class="span-4 right"></span>  -->
		</div>
