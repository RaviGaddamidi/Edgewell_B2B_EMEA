...
<template:page pageTitle="${pageTitle}">
	...
	<div class="column companyContentPane clearfix">
		...
		<div class="headline"><spring:theme code="text.company.manageUsergroups.remove" text="Confirm Remove" arguments="${usergroup.uid}"/></div>
		<div class="description"><spring:theme code="text.company.manageUsergroups.remove.confirmation" text="Doing this will remove User Group : {0} . Do you want to proceed?" arguments="${usergroup.uid}"/></div>
