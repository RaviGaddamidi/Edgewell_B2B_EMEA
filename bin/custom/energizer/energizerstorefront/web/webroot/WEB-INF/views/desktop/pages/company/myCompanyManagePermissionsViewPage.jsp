...
<template:page pageTitle="${pageTitle}">
	...
	<div class="column companyContentPane clearfix orderList">
		...
		<div class="right">
			<a href="${editPermissionDetailsUrl}" class="button edit"><spring:theme
					code="text.company.costCenter.button.displayName" /></a>
			<c:choose>
				<c:when test="${permissionData.active}">
					<a href="${disableUrl}" class="button disable"><spring:theme
							code="text.company.budget.disableButton.displayName" /></a>
				</c:when>
				<c:otherwise>
					<a href="${enableUrl}" class="button enable"><spring:theme
							code="text.company.budget.enableButton.displayName" /></a>
				</c:otherwise>
			</c:choose>
		</div>
		<div class="table_permission_cls">
			<table class="table_budget orderListTable">
				...
				<c:if
					...
					<tr>
						...
						<td><fmt:formatNumber value="${permissionData.value}" /></td>
