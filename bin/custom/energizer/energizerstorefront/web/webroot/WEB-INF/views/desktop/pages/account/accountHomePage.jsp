    ...
    <div class="span-20 last customAccount">
        ...
        <sec:authorize ifAllGranted="ROLE_B2BCUSTOMERGROUP">
         ...
         <div class="tile column quotes-dasshboard">
            ...
            <div class="tile column QuickOrders">
            	...
            	<ul>
                	<ycommerce:testId code="myAccount_options_profile_groupbox">
                	    <li><a href="${encodedUrl}"> <spring:theme code="text.account.profile.QuickOrderForm" text="Quick Order Form"/> </a></li>
                	</ycommerce:testId>
            	</ul>
       		</div>
       		<div class="tile column FileUpload">
            	<c:url value="/my-account/excelfileupload" var="encodedUrl" />
            	<div class="headline"><a href="${encodedUrl}"> <spring:theme code="text.account.profile.QuickOrders" text="Excel Order"/> </a></div>
            	<ul>
                	<ycommerce:testId code="myAccount_options_profile_groupbox">
                	    <c:url value="/my-account/excelfileupload" var="encodedUrl" />
                	    <li><a href="${encodedUrl}"> <spring:theme code="text.account.excelUpload.FileUpload" text="Excel Order"/> </a></li>
                	</ycommerce:testId>
            	</ul>
       		</div>
			</sec:authorize>
            ...
            <div class="tile column orderHistory">
                ...
                <ul>
                    <ycommerce:testId code="myAccount_options_orderHistory_groupbox">
                       ...
                       <%--
                       This  replenishment link has been commented. as of this is not in scope
        ...
        <sec:authorize ifAllGranted="ROLE_B2BAPPROVERGROUP">
            <div class="tile column approval-dashboard">
                ...
                <div class="headline"><a href="${encodedUrl}"><spring:theme code="text.account.orderApproval" text="Order Approval"/></a></div>
                <ul>
