		...
		<tbody>
			<c:forEach items="${cartData.entries}" var="entry">
				...
				<tr class="cartItem">
					...
					<td headers="header9" class="quantity">
								...
								<c:when test="${not entry.product.multidimensional}" >
									<ycommerce:testId code="cart_product_quantity">
										...
										<c:if test="${entry.updateable}" >
											<form:input disabled="${not entry.updateable}" type="text" size="1" id="quantity_${entry.entryNumber}" class="qty" path="quantity"/>
										</c:if>
									</ycommerce:testId>
			...
			<tr class="cartItem">
				...
				<th colspan="3">
					<input name="volume_txt" type="hidden" id="volume_txt" value="${ cartData.totalProductVolumeInPercent}"><br/>
					<input name="weight_txt" type="hidden" id="weight_txt" value="${ cartData.totalProductWeightInPercent}"><br/>	
					<input name="isContainerFull" type="hidden" id="isContainerFull" value="${ cartData.isContainerFull}"><br/>	
				</th>
