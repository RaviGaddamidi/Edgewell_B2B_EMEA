 ...
 *  
 */
package com.energizer.test.setup;
 ...
 */
@SystemSetup(extension = EnergizerTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			importImpexFile(context, "/energizertest/import/qa-organization.impex");
