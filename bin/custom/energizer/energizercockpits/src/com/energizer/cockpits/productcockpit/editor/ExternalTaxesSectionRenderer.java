 ...
 *
 */
package com.energizer.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("energizercockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("energizercockpits.product.externalTaxes"));
