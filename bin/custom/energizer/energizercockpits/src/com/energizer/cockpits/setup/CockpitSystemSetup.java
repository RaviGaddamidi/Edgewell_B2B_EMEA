 ...
 *
 */
package com.energizer.cockpits.setup;
...
import com.energizer.cockpits.constants.EnergizerCockpitsConstants;
 ...
 */
@SystemSetup(extension = EnergizerCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(EnergizerCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(EnergizerCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						EnergizerCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/energizercockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
